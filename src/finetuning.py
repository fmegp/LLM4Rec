"""
Colab-ready CLI wrapper for the finetuning stage.
...
def main() -> None:
    ...
    parser.add_argument("--output_dir", type=str, required=True, help="Where to write finetuning artifacts.")
    parser.add_argument(
        "--pretrained_dir",
        type=str,
        required=True,
        help="Path to training artifacts (usually: <output_dir>/training).",
    )
